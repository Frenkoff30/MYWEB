    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section id="hero" className="relative flex min-h-[calc(100svh-4.5rem)] flex-col justify-center overflow-hidden px-6 pb-6 pt-2 sm:min-h-0 sm:pb-14 sm:pt-6">
          ...
          <span
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-0 h-[300px] w-[420px] max-w-[120%] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(59,130,246,0.10),transparent_70%)] sm:h-[560px] sm:w-[980px]"
          />
          ...
          <Reveal delay={350}>
            <div className="relative z-[1] -mx-6 mt-9 sm:mt-10">
              <ProjectsMarquee />
            </div>
          </Reveal>
        </section>
                ...
                <div className="flex h-full flex-col gap-4">
                  {[
                    ...
                    { icon: (
                      ...
                      ), label: "E-mail", value: "webostudio@seznam.cz", href: "mailto:webostudio@seznam.cz" },
                    { icon: (
